...
{
    /**
     * Parses the payload given a list of properties and returns the list of values in the same order the properties
     * are given. When a property does not exist and a defaultValue is provided, that defaultValue is used. Otherwise
