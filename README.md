...
protocol ([RFC 8555](https://www.rfc-editor.org/rfc/rfc8555)). Non-blocking I/O is scheduled under the hood
by [Revolt](https://revolt.run/).

> [!TIP]
> If you're looking for a PHP client, have a look at [`kelunik/acme-client`](https://github.com/kelunik/acme-client)
